      ...
      <div className="hidden lg:flex flex-col justify-between bg-sidebar text-sidebar-foreground p-12">
        ...
        <div>
          <h2 className="font-display text-3xl font-semibold leading-tight">
            One copilot for email, meetings, planning, and research.
          </h2>
          <p className="mt-3 text-sm text-sidebar-foreground/70 max-w-md">
            Sign in to access your AI workplace tools and threaded chat history.
          </p>
        </div>
        <p className="text-xs text-sidebar-foreground/50">
          AI-generated output may be inaccurate. Review before acting.
        </p>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "signin"
              ...
              : "Start using your AI productivity tools."}
          </p>
